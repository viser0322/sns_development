  ...
  <table class="table">
    ...
    <tbody>
      ...
      <tr>
        <th>自己紹介</th>
        <td>
          <textarea name="detail" class="form-control @error('detail') is-invalid @enderror">{{ old('detail') ?: $user->detail }}</textarea>
          @error('detail')
          <span class="invalid-feedback" role="alert">{{ $message }}</span>
          @enderror
        </td>
      ...
      <tr>
        <th>入社日</th>
        <td>
          <input type="date" name="hire_date" class="form-control @error('hire_date') is-invalid @enderror" value="{{ old('hire_date') ?: $user->hire_date }}">
          @error('hire_date')
          <span class="invalid-feedback" role="alert">{{ $message }}</span>
          @enderror
        </td>
